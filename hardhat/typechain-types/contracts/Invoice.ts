...
export interface Invoice extends BaseContract {
  ...
  INVOICE_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  getInvoice: TypedContractMethod<
    [],
    [BillDefinition.BillStructOutput],
    "view"
  >;
  ...
  ): TypedContractMethod<[], [BillDefinition.BillStructOutput], "view">;
  getFunction(
