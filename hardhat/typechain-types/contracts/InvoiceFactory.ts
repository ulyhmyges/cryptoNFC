...
export interface InvoiceFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "createInvoice"
  ...
  encodeFunctionData(
    ...
    values: [BillDefinition.BillStruct]
  ): string;
  encodeFunctionData(
...
export interface InvoiceFactory extends BaseContract {
  connect(runner?: ContractRunner | null): InvoiceFactory;
